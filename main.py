...
def main():
    ...
    g = game.game((cells_x, cells_y), cell_size, rulestring)
    ...
    decorator.fill_with_noise(0)
    decorator.place_pattern('germ', (100, 100))
    decorator.place_pattern('gosperglidergun', (0, 100))
    ...
    surface = pygame.display.set_mode(
        (cell_size * cells_x, cell_size * cells_y))
    pygame.display.set_caption(
        f'Game of Life: Gen = {gen}, Running = {active}')
